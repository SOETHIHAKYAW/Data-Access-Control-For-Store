...
<body class="bg-dark">
		<h3 align="center">This is Laptops Series that are most comfortable to buy and most cheapest in here</h3>
			...
			<div id="div" class="col-md-3">
				...
				<c:url var="buyLink" value="laptop">
					...
					<img src="assets/imgs/laptops/macpro20.jpg" id="img" width="100px" height="60px">
						<h5> ID :  <c:out value="${laptop.goodsid}"></c:out> </h5>
						 <h5>Name : <c:out value="${laptop.name}"></c:out> </h5> 
						 <h5>Price : <c:out value="${laptop.price}"></c:out> Ks</h5> 
						 <h5>Quantity : <c:out value="${laptop.quantity}"></c:out> </h5> 
