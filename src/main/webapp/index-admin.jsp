			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<c:if test="${user.role == 'admin'}">
						<li class="nav-item"><a class="nav-link" href="sale">Sale
								Table</a></li>

						<li class="nav-item"><a class="nav-link" href="additems.html">Add
								Items</a></li>
					</c:if>
			...
			<tbody>
				...
				<c:forEach var="items" items="${itemsList }">
					...
					<tr>
						...
						<td><img alt="" src="${items.imgname }" width="100px"
							height="100px"></td>
						...
						<c:if test="${user.role == 'admin'}">
							<td><a class="btn btn-primary" href="${update}"> Edit </a> <a
								class="btn btn-danger" id="delete" href="${delete}"> Delete
							</a></td>
						</c:if>
					</tr>
