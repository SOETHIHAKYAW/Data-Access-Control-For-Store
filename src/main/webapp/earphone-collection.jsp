...
<body class="bg-dark">
	<h3 align="center">This is Earphone Series that are most
	...
	<div class="row md-3">
		<c:forEach var="earphone" items="${earphoneList}">
			...
			<div id="div" class="col-md-3">
				...
				<img src="${earphone.imgname }" width="200px" height="200px">
				<h5>
					ID :
					<c:out value="${earphone.goodsid}"></c:out>
				</h5>
				<h5>
					Name :
					<c:out value="${earphone.name}"></c:out>
				</h5>
				<h5>
					Price :
					<c:out value="${earphone.price}"></c:out>
					Ks
				</h5>
				<h5>
					Quantity :
					<c:out value="${earphone.quantity}"></c:out>
				</h5>
